...
import { AlertCircle, ArrowRight, Sparkles, KeyRound, Mail, Database } from 'lucide-react';
...
export default function Login() {
  ...
  const { signInWithPassword, signInWithOtp, signInWithOAuth, isConfigured, loginAsDemo } = useAuth();
